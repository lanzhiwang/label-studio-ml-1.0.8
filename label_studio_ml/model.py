...
print("model.py __name__:", __name__)
# model.py __name__: label_studio_ml.model
...
class LabelStudioMLManager(object):
    ...
    def initialize(
        ...
        **init_kwargs
        ...
        print("model.py LabelStudioMLManager cls.model_class:", cls.model_class)
        print("model.py LabelStudioMLManager cls.model_dir:", cls.model_dir)
        print("model.py LabelStudioMLManager cls.redis_host:", cls.redis_host)
        print("model.py LabelStudioMLManager cls.redis_port:", cls.redis_port)
        print("model.py LabelStudioMLManager cls.redis_queue:", cls.redis_queue)
        print("model.py LabelStudioMLManager cls.train_kwargs:", cls.train_kwargs)
        print("model.py LabelStudioMLManager cls._redis:", cls._redis)
        print("model.py LabelStudioMLManager cls._redis_queue:", cls._redis_queue)
        print("model.py LabelStudioMLManager cls._current_model:", cls._current_model)
        print("model.py LabelStudioMLManager cls.init_kwargs:", cls.init_kwargs)
        # model.py LabelStudioMLManager cls.model_class: <class 'model.SimpleTextClassifier'>
        # model.py LabelStudioMLManager cls.model_dir: ./my_backend
        # model.py LabelStudioMLManager cls.redis_host: localhost
        # model.py LabelStudioMLManager cls.redis_port: 6379
        # model.py LabelStudioMLManager cls.redis_queue: default
        # model.py LabelStudioMLManager cls.train_kwargs: None
        # model.py LabelStudioMLManager cls._redis: None
        # model.py LabelStudioMLManager cls._redis_queue: None
        # model.py LabelStudioMLManager cls._current_model: {}
        # model.py LabelStudioMLManager cls.init_kwargs: {}
    ...
    def fetch(cls, project=None, label_config=None, force_reload=False, **kwargs):
        print("model.py fetch project:", project)
        print("model.py fetch label_config:", label_config)
        print("model.py fetch force_reload:", force_reload)
        print("model.py fetch kwargs:", kwargs)
        # model.py fetch project: 1.1709187777
        # model.py fetch label_config:
        # <View>
        ...
        # </Choices>
        # </View>
        # model.py fetch force_reload: False
        # model.py fetch kwargs: {'hostname': 'http://localhost:8080', 'access_token': '0327fc45919b33b67e13daf121ded44d896023b1'}

        print("model.py fetch", os.getenv('LABEL_STUDIO_ML_BACKEND_V2', default=LABEL_STUDIO_ML_BACKEND_V2_DEFAULT))
        print("model.py fetch", cls.without_redis())
        # model.py fetch False
        # model.py fetch True
        if not os.getenv('LABEL_STUDIO_ML_BACKEND_V2', default=LABEL_STUDIO_ML_BACKEND_V2_DEFAULT):
            # TODO: Deprecated branch since LS 1.5
            ...
            print("model.py fetch job_result:", job_result)
            # model.py fetch job_result: {}
            train_output = job_result.get('train_output')
