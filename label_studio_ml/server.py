...
print("server.py __name__:", __name__)
# server.py __name__: label_studio_ml.server
...
# args: Namespace(command='start', project_name='my_backend', root_dir='.')
# subargs: []
def start_server(args, subprocess_params):
    project_dir = os.path.join(args.root_dir, args.project_name)
    print("server.py project_dir:", project_dir)
    # server.py project_dir: ./my_backend

    wsgi = os.path.join(project_dir, '_wsgi.py')
    print("server.py wsgi:", wsgi)
    # server.py wsgi: ./my_backend/_wsgi.py

    print('server.py python ' + wsgi + ' ' + ' '.join(subprocess_params))
    # server.py python ./my_backend/_wsgi.py
...
def main():
    ...
    print("server.py args:", args)
    print("server.py subargs:", subargs)
    # server.py args: Namespace(command='start', project_name='my_backend', root_dir='.')
    # server.py subargs: []
